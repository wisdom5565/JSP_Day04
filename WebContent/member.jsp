...
<body>
    ...
    <form action="./member_ok.jsp" name="regform" id="regform" method="post" onsubmit="return sendit()">
        ...
        <p>아이디 <input type="text" id="userid" name="userid" maxlength="20" onkeyDown="idModify()">
         <input type="button" id="btnIdCheck" value="중복체크" onClick="clickBtn()">
        </p>
            <p id="checkmsg">
            </p>
        <p>
            비밀번호 <input type="password" id="userpw" name="userpw" maxlength="20">
        </p>
        <p>
            비밀번호 확인 <input type="password" id="userpw_re" name="userpw_re" maxlength="20">
        </p>
        <p>
            이름 <input type="text" name="name" id="name">
        </p>
        <p>
            핸드폰번호 <input type="text" name="hp" id="hp">
        </p>
        <p>
        ...
        <p>
            ...
            <label>책읽기<input type="checkbox" name="hobby" value="책읽기"></label>
        ...
        <p>우편번호<input type="text" id="sample6_postcode" name="zipcode" maxlength="5"> <button onclick="sample6_execDaumPostcode()"  type="button">검색</button>
    	...
    	<p><a href="login.jsp">이미 회원이신가요?</a></p>
</body>
</html>